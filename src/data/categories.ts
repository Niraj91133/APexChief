...
export const CATEGORIES: Category[] = [
  {
    "name": "Home",
    "slug": "home",
    "description": "ApexChief frontpage, breaking editorial highlights, executive briefs, and market indices.",
    "layout": "world-layout",
    "order": 1,
    "isVisible": true,
    "subcategories": [
      {
        "name": "Frontpage Featured",
        "slug": "frontpage-featured",
        "description": "Homepage top lead stories and editorial centerpiece features."
      },
      {
        "name": "Hero Highlight",
        "slug": "hero-highlight",
        "description": "Hero grid highlights and executive breaking headlines."
      },
      {
        "name": "Market Overview",
        "slug": "market-overview",
        "description": "Live market pulse, sovereign wealth indicators, and global indexes."
      }
    ]
  },
  {
